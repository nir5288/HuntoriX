...
export const OpportunitiesFilters: React.FC<OpportunitiesFiltersProps> = ({
  ...
  return <div className="space-y-4">
      ...
      <div className="flex items-center justify-between pb-3 border-b">
        ...
        <Button variant="destructive" size="sm" onClick={resetFilters} className="h-9 px-3 text-slate-950 bg-yellow-500 hover:bg-yellow-400">
      ...
      {hasHuntorix && <div className="p-3 rounded-md bg-gradient-to-r from-purple-500/20 via-blue-500/20 to-cyan-500/20 border border-purple-500/30">
