          ...
          return (
            <div key={message.id}>
              ...
              <div className={cn(
                ...
                isMobile && isFromMe && "flex-row-reverse"
              )}>
                {!isMobile && (
                ...
                <div className={cn(
                  ...
                  <div className={cn(
                    "rounded-lg px-4 py-2 relative group-hover:bg-muted/80 transition-colors",
                    isMobile && isFromMe 
                      ? "bg-gradient-to-r from-[hsl(var(--accent-mint))]/20 to-[hsl(var(--accent-lilac))]/20 ml-auto"
                      : "bg-muted"
                  )}>
                    {isEditing ? (
