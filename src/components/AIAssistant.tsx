          ...
          <div className="flex items-center justify-between p-5 border-b border-white/10 bg-gradient-to-r from-cyan-400/20 via-blue-400/20 to-purple-400/20 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="flex items-center gap-1 relative z-10">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-32 bg-background/95 backdrop-blur-xl border border-white/20 shadow-2xl z-[10000] rounded-xl p-1">
                  <DropdownMenuItem
                    onClick={() => {
                      setLanguage('en');
                      toast({
                    ...
                    className="flex items-center gap-2 px-3 py-2 cursor-pointer rounded-lg hover:bg-white/10 transition-colors"
                  >
